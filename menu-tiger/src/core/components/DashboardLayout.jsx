...
const DashboardLayout = () => {
  ...
  const [updates, setUpdates] = useState([
    {
      ...
      description: "Learn the customization guide and image update for your menu QR codes."
    },
  ...
  const filteredUpdates = activeFilter === "All"
    ? updates
    : updates.filter(update => update.type.toLowerCase() === activeFilter.toLowerCase());
  ...
  return (
    <div className={`${darkMode ? "dark" : ""} flex h-screen bg-gray-100 dark:bg-gray-900`}>
      {/* Sidebar */}
      <aside
        className={`bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 fixed top-21 left-0 h-full z-[5] ${sidebarOpen ? "w-72" : "w-20"
            ...
            <div className={`relative flex justify-center ${isMobile ? "hidden" : "flex"}`}>
              <div className="relative">
                ...
                {showLanguageDropdown && (
                  <div className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 z-50 max-h-96 overflow-y-auto scrollbar-thin"
                    style={{
                      scrollbarWidth: 'thin',
        ...
        `}</style>
                    {languages.map((lang) => (
                      <button
                        ...
                        className={`flex items-center w-full px-4 py-3 text-sm ${language === lang.code
                      ...
                      >
                        ...
                        {language === lang.code && (
                          <span className="ml-2 text-primary dark:text-teal-300">✓</span>
                        )}
                      </button>
                    ))}
                  </div>
            ...
            {/* Notification Panel (full height, top-right positioned) */}
            {showNotifications && (
              <div
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <span className="text-xs bg-yellow-400 text-white px-2 py-0.5 rounded-full">0</span>
                  </div>
                  ...
                  <div className="mb-6 space-y-4">
                    ...
                    <div className="relative">
                      <select
                        className="w-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-600 rounded-md p-2 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-secondary"
                      >
                      ...
                      <img
                        ...
                        style={{ filter: 'invert(48%) sepia(79%) saturate(2476%) hue-rotate(130deg) brightness(95%) contrast(96%)' }}
                      />
                    </div>

                    {/* Second dropdown: Notification category */}
                    <div className="relative">
                      <select
                        className="w-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-600 rounded-md p-2 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-secondary"
                      >
                  ...
                  <div className="flex flex-col items-center text-center mt-12 text-gray-600 dark:text-gray-400">
                    ...
                    />
                    <h4 className="text-lg font-medium">You're all caught up!</h4>
                    <p className="mt-2 text-sm">We'll notify you when something new comes up</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {showProductTour && (
              <div
                ...
                onClick={() => setShowProductTour(false)} // Close when clicking outside
              >
                <div
                ...
                >
                  ...
                  <div className="px-4 pt-4 text-center">
                    <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Welcome to the Menu Tiger!</h3>
                  ...
                  {/* Onboarding checklist progress toggle */}
                  <div className="px-4 mt-8">
                    <div className="">
                      <button
                        onClick={() => setShowStep(showStep === 'checklist' ? null : 'checklist')}
                      ...
                      >
                        <div className="flex items-start justify-between w-full">
                          ...
                          <div className="flex items-start space-x-4">
                            ...
                            <div>
                              <span className="block font-medium text-lg">Onboarding checklist progress</span>
                            </div>
                          </div>

                          {/* Arrow icon */}
                          <svg
                            className={`w-6 h-6 transition-transform duration-200 ${showStep === 'checklist' ? 'rotate-180' : 'rotate-0'} cursor-pointer`}
                            fill="none"
                            stroke="currentColor"
                            strokeWidth="2"
                            viewBox="0 0 24 24"
                        ...
                        <div className="flex items-center justify-between mt-5 space-x-4">
                          ...
                          <span className="text-secondary font-semibold text-base ml-2">0%</span>
                        </div>
                      </button>
                    </div>

                    {/* Checklist steps - show/hide based on toggle */}
                    {showStep === 'checklist' && (
                        ...
                        <div className="flex items-start mb-8">
                          ...
                          <div className="flex-grow">
                            ...
                            <p className="text-base text-gray-500 dark:text-gray-400 mt-3">
                              These are the basic information about the restaurant. Contact details, languages, currency and cover image
                            </p>
                          </div>
                        </div>
            ...
            <div className="relative group">
              <button
                ...
                title="What's New"
                className="relative flex items-center justify-center w-10 h-10 bg-fifth dark:bg-gray-700 rounded-md hover:bg-secondary transition-colors duration-200 cursor-pointer"
              >
                <img
            ...
            {showWhatsNew && (
              <div className="fixed inset-0 z-50 bg-gray-900/30" onClick={() => {
                setShowWhatsNew(false);
                setShowSearchFilters(false);
              }}>
                <div className="fixed top-0 right-0 h-full w-full max-w-sm bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 shadow-xl p-6 overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                  {/* Header */}
                  <div
                    className={`flex items-center mb-6 px-6 py-4 -mx-6 -mt-6 ${showSearchFilters ? 'bg-white dark:bg-gray-800' : 'bg-primary'
                      }`}
                  >
                    {showSearchFilters ? (
                      <button
                  ...
                  {!showSearchFilters ? (
                    ...
                    <div className="space-y-4">
                      {filteredUpdates.map(update => (
                        <div key={update.id} className="bg-fifth dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                          <div className="flex justify-between items-center mb-2">
                            <div className="flex items-center">
                              <span className="text-xs font-medium text-secondary dark:text-teal-300 mr-2">{update.type}</span>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        {["All", "Announcement", "Improvement", "New"].map(filter => (
                          <button
                            key={filter}
                            onClick={() => {
                            ...
                            className={`flex items-center w-full cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-2 text-left rounded-md ${activeFilter === filter
                              ? "text-gray-600"
                              : ""
                              }`}
                          >
                  ...
                  <div className="fixed bottom-0 right-0 w-full max-w-sm bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4">
                    <p className="text-sm text-gray-500 dark:text-gray-400 text-center">We are ⚡by Beamer</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="relative">
              <button
                ...
                className="group flex items-center space-x-2 rounded-full bg-fifth px-3 py-1 hover:bg-secondary hover:text-white transition-colors duration-200 cursor-pointer"
                aria-haspopup="true"
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-700 rounded-md shadow-lg py-1 z-20 border border-gray-200 dark:border-gray-600">
                  ...
                  <div className="mx-4 mb-6 px-4 py-4 space-y-4 bg-[#FFF8E1] dark:bg-[#2a2118] rounded-md">
                    ...
                    <button
                      className="mt-3 w-fit bg-[#FFE57F] hover:bg-[#FFC107] text-gray-800 cursor-pointer dark:text-gray-900 text-sm sm:text-base font-semibold py-2 px-4 rounded-md transition-colors duration-200"
                    >
                      Check Plans
                    </button>
                  </div>
                  ...
                  <div className="px-3 pb-3">
                    ...
                    >
                      <FaCog size={16} className="text-gray-500 dark:text-gray-400" />
                      Restaurant Settings
                    </a>
                    ...
                    <a
                      ...
                      className="flex items-center gap-3 px-3 py-3 text-sm sm:text-[0.95rem] text-gray-700 dark:text-gray-300 hover:bg-[#F3F4F6] dark:hover:bg-gray-600 transition rounded-md"
                    >
                      <FaSignOutAlt size={16} className="text-gray-500 dark:text-gray-400" />
                      Logout
                    </a>
                  </div>
                </div>
