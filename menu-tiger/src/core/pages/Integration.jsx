    ...
    <div className="p-6 bg-gray-100 dark:bg-gray-900 min-h-screen text-gray-900 dark:text-gray-100">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        ...
        <div className="flex border-b border-gray-200 dark:border-gray-700 relative">
          <button
            className={`px-6 py-3 font-medium text-sm flex items-center cursor-pointer ${activeTab === "payment" ? "text-primary border-b-2 border-primary" : "text-gray-600 dark:text-gray-400"}`}
          ...
          <div className="relative">
            <div
              className={`px-6 py-3 font-medium text-sm flex items-center ${activeTab === "whiteLabel" ? "text-primary border-b-2 border-primary" : "text-gray-600 dark:text-gray-400"} cursor-not-allowed opacity-70`}
            ...
            >
              ...
              {hoveredTab === "whiteLabel" && (
                <div
                  className="absolute top-full left-0 mt-1 w-[500px] z-50 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-2xl p-5"
                  onMouseEnter={() => setHoveredTab("whiteLabel")}
                  onMouseLeave={() => setHoveredTab(null)}
                >
                  <div className="text-left">
                    <h3 className="font-medium text-gray-800 mb-3 text-lg">Access Denied</h3>
                    <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
                      You do not have permission to use this feature due to limitations in your current plan. Please upgrade or adjust your plan to gain access.
                    </p>
                    <div className="flex justify-center space-x-2">
                      <button
                        className="px-4 py-2 text-primary border border-primary  dark:bg-gray-700 hover:text-secondary dark:text-gray-200 rounded-sm hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors text-sm"
                        onClick={(e) => {
                          e.stopPropagation();
                      ...
                      <button
                        className="px-4 py-2 bg-secondary dark:bg-gray-700 text-white dark:text-gray-200 rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors text-sm"
                        onClick={(e) => {
                          e.stopPropagation();
          ...
          <div className="relative">
            <div
              className={`px-6 py-3 font-medium text-sm flex items-center ${activeTab === "printers" ? "text-primary border-b-2 border-primary" : "text-gray-600 dark:text-gray-400"} cursor-not-allowed opacity-70`}
            ...
            >
              ...
              {hoveredTab === "printers" && (
                <div
                  className="absolute top-full left-0 mt-1 w-[500px] z-[1000] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-2xl p-5"
                  onMouseEnter={() => setHoveredTab("printers")}
                  onMouseLeave={() => setHoveredTab(null)}
                >
                  <div className="text-left">
                    <h3 className="font-medium text-gray-800 mb-2">Access Denied</h3>
          ...
          <button
            className={`px-6 py-3 font-medium text-sm flex items-center cursor-pointer ${activeTab === "pos" ? "text-primary border-b-2 border-primary" : "text-gray-600 dark:text-gray-400"}`}
              ...
              {!showEditPage ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="border rounded-lg p-4 hover:shadow-md transition-shadow duration-200 flex flex-col">
                    ...
                    <div className="flex-grow">
                      <h3 className="font-medium text-left mb-2">Custom Payment</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400 text-left">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      <label className="flex items-center">
                        <input
                          ...
                          onChange={() => setIsCustomPaymentEnabled(!isCustomPaymentEnabled)}
                        />
                        <div className="relative w-11 h-6">
                          <div className="absolute inset-0 bg-gray-300 dark:bg-gray-700 rounded-full peer-checked:bg-primary transition-colors duration-200"></div>
                          <div className="absolute top-[2px] left-[2px] w-5 h-5 bg-white rounded-full border border-gray-300 transform transition-all duration-200 peer-checked:translate-x-5"></div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <span className="border border-primary px-4 py-3 flex items-center rounded-sm">
                          ...
                          This option allows customers to choose custom payment arrangements
                        </span>
                      </div>
                    </div>
                    <button
                  ...
                  {customPayments.length > 0 ? (
                      ...
                      <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                          {customPayments.map((payment) => (
                            <tr key={payment.id}>
                              <td className="py-3 px-4 text-gray-600 dark:text-gray-300">{payment.name}</td>
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      if (window.confirm(`Are you sure you want to delete "${payment.name}"?`)) {
                                        setCustomPayments(customPayments.filter(p => p.id !== payment.id));
                                      }
                                    }}
                                  >
                                    <FaTrash />
                    ...
                    <div className="border rounded-lg p-8 text-center bg-gray-50 dark:bg-gray-700">
                      <div className="flex flex-col items-center justify-center">
                        <FaQuestionCircle className="text-yellow-500 text-3xl mb-3" />
                        <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-1">
                          No custom payment options
                        </h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Add your first custom payment option by clicking the button above
                        </p>
                      </div>
                    </div>
                  )}
